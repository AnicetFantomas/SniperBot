        ...
        outputs: [
            {
                components: [
                    ...
                    { internalType: 'uint256', name: 'actualBuy', type: 'uint256' },
                    { internalType: 'uint256', name: 'estimatedSell', type: 'uint256' },
                    { internalType: 'uint256', name: 'actualSell', type: 'uint256' },
                    { internalType: 'uint256', name: 'buyGas', type: 'uint256' },
                    { internalType: 'uint256', name: 'sellGas', type: 'uint256' },
                ],
                internalType: 'struct IRugCheckResponse.RugCheckResponse',
                name: 'response',
                type: 'tuple',
            },
        ],
